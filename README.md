...
# Cast Moderator Rubber Ducky
Cast Moderator Rubber Ducky is an Arduino script used to setup Cast Moderator 
...
2. Edit in an Arduino IDE to enter your WifFi SSID, Password, Google Workspace Username, and Password.          
   - Optionally adjust timings where needed to acoomodate network speed and potential downloads. 
